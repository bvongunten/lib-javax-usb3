...
public final class JNINativeLibraryLoader {
    ...
    public static void load() {
        ...
        try {
            ...
            try (InputStream inputStream = JNINativeLibraryLoader.class.getClassLoader().getResourceAsStream("META-INF/nativelib/" + getOSName() + "/" + getOSArch() + "/" + getLibraryFilename())) {
...
//      destination.toFile().deleteOnExit();
    ...
    private static void loadMissingLib() throws URISyntaxException, IOException {
         ...
         * library from the jar file into a temp directory.
         */
        // Should also work from jar in jar ;)
        try (InputStream inputStream = JNINativeLibraryLoader.class.getClassLoader().getResourceAsStream("META-INF/nativelib/" + getOSName() + "/" + getOSArch() + "/" + getMissingLibraryName())) {
